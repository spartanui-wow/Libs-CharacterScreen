...
function Portrait:OnFrameHide() end
...
function Portrait:ApplyFallbackBackground(textureKit)
	...
	local fallbackTexture = string.format('Interface\\AddOns\\Libs-CharacterScreen\\media\\frame\\UIFrame%s.png', textureKit:gsub('^%l', string.upper))
