...
---@class LibCS.Reputation : AceModule, AceEvent-3.0, AceHook-3.0
local Reputation = LibCS:NewModule('Reputation', 'AceEvent-3.0', 'AceHook-3.0')
...
function Reputation:UpdateReputationDisplay()
	...
	if C_AddOns.IsAddOnLoaded('PrettyReps') then
		return
	end
