...
function FrameManager:RepositionSlots()
    ...
    if #bottomSlots == 2 then
        local mainHandSlot = customSlots[equipmentModule:GetSlotIDFromName(bottomSlots[1])]
        local offHandSlot = customSlots[equipmentModule:GetSlotIDFromName(bottomSlots[2])]
...
function FrameManager:OpenSettingsDialog()
    ...
    print('LibCS Settings - Coming soon!')
    print('Available modules:', table.concat(self:GetModuleList(), ', '))
end
